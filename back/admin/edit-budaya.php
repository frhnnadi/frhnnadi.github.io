...
<div id="content-header">
	<div id="breadcrumb">
		...
		<a class="current"><i class="icon-pencil"></i>Update</a>
	</div>
    <h1>UPDATE BUDAYA!</h1>
</div>
...
<hr>
  <div class="widget-box">
	...
	<form action="edit-budaya-act.php" method="post" class="form-horizontal">
        ...
        <div class="form-actions">
        	<div class="controls">
	          <a href="budaya.php" class="btn btn-danger col-md-2"> Back</a>
